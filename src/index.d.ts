...
declare namespace AppsScriptJobqueue {
  ...
  export const JobParameter: JobParameter;
  export const DelayedJobBroker: DelayedJobBroker<Parameter>;
...
declare let JobBroker: AppsScriptJobqueue.JobBroker;
